  ...
  return (
    <div>
      <h5 className='p-1 text-center absolute top-0' onClick={() => {
        ...
        <div onClick={() => setConfirmRidePanel(true)} className='flex w-full border-2 active:border-black mb-2 rounded-xl p-3 items-center justify-between'>
          <img className='h-[60px]' src='https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,h_552,w_552/v1555367310/assets/30/51e602-10bb-4e65-b122-e394d80a9c47/original/Final_UberX.png' alt='' />
